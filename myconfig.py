...
STEERING_LEFT_PWM = 422         #pwm value for full left steering
STEERING_RIGHT_PWM = 316        #pwm value for full right steering
# THROTTLE_CHANNEL = 0            #(deprecated) channel on the 9685 pwm board 0-15
THROTTLE_FORWARD_PWM = 525      #pwm value for max forward throttle
